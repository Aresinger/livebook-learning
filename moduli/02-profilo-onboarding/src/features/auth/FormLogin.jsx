              ...
              <form className="card-inner space-y-5" onSubmit={handleSubmit}>
                ...
                {status === "failed" ?
                 error.code === "invalid_credentials" ?
                  <p className="text-red-300 text-sm">{`Credenziali non valide. `}</p> : 
                  <p className="text-red-300 text-sm">{`Confermare l'email prima di accedere. `}</p> :
                   null
                }
                {/* {status === "failed" && error.message === "Invalid login credentials"(
                  <p className="text-red-300 text-sm">{`Credenziali non valide. `}</p>
                )} */}
                {/* Main CTA */}
                <button
